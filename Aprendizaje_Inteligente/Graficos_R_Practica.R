...
plot(x, y, main = "Titulo principal",
     sub = "subtitulo",
     xlab = "Etiqueta Eje X", ylab = "Etiqueta Eje Y",
...
text(runif(5, 1, 10), runif(5, 1, 10),
     labels = c("uno", "dos", "tres", "cuatro", "cinco"),
     cex = 1.7, col = rainbow(5), abline(h = 5, lty = 2))
